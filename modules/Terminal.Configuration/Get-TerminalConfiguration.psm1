Import-Module (Join-Path $PSScriptRoot 'Get-TerminalSettingsPath.psm1') -ErrorAction Stop

Import-Module (Join-Path $PSScriptRoot '..\_Tests\Test-TerminalMinimumVersion.psm1') -ErrorAction Stop
Import-Module (Join-Path $PSScriptRoot '..\_Tests\Test-TerminalConfigurationSerialization.psm1') -ErrorAction Stop
