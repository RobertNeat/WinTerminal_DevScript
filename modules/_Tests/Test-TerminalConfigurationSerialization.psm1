Import-Module (Join-Path $PSScriptRoot '..\terminal.configuration\Get-TerminalSettingsPath.psm1') -ErrorAction Stop
Import-Module (Join-Path $PSScriptRoot 'Test-ObjectEqualityDeep.psm1') -ErrorAction Stop
